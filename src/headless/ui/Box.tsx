...
export type BoxProps<C extends React.ElementType = 'div'> = PolymorphicComponentProps<
  C,
  {
    component?: C;
    children?: ReactNode;
...
export const Box = forwardRef(BoxComponent) as <C extends React.ElementType = 'div'>(
  props: BoxProps<C>,
  ref?: PolymorphicRef<C>
) => JSX.Element;

...
export const Grid = forwardRef(function Grid<C extends React.ElementType = 'div'>(
  { className, columns, rows, gap, gapX, gapY, align, justify, style: injectedStyle, ...rest }: GridProps<C>,
...
}) as <C extends React.ElementType = 'div'>(props: GridProps<C> & { ref: PolymorphicRef<C> }) => JSX.Element;
